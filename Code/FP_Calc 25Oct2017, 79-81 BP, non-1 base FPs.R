...
close(fileConn)
file.create("Results/1AKTR17, 79-81 non-1 base FP.fpa") #rlp note: changed to gen non-1 base FP
fileConn<-file("Results/1AKTR17, 79-81 non-1 base FP.fpa", "w") #rlp note: changed to gen non-1 base FP
...
tmp=readLines(fileConn)
close(fileConn)
file.create("Results/5WCRBT17, 79-81 non-1 base FP.fpa") #rlp note: changed to gen non-1 base FP
fileConn<-file("Results/5WCRBT17, 79-81 non-1 base FP.fpa", "w") #rlp note: changed to gen non-1 base FP
...
tmp=readLines(fileConn)
close(fileConn)
file.create("Results/3NTR17, 79-81 non-1 base FP.fpa") #rlp note: changed to gen non-1 base FP
fileConn<-file("Results/3NTR17, 79-81 non-1 base FP.fpa", "w") #rlp note: changed to gen non-1 base FP
