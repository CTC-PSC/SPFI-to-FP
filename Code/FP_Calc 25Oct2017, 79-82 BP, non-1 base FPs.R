...
#Read in SPFI data
spfiDAT.seak <- readSPFI("Data/SEAK15LC_4000, 79-82 BP.CSV", "Data/seak_spfi.csv")
spfiDAT.nbc  <- readSPFI("Data/NBC15LC_CT, 79-82 BP.CSV", "Data/nbc_spfi.csv")
spfiDAT.nbc  <- spfiDAT.nbc[,-4]
names(spfiDAT.nbc) <- c("YEAR", "SPFI", "Total")
spfiDAT.nbc$YEAR = as.numeric(spfiDAT.nbc$YEAR)
spfiDAT.wcvi <- readSPFI("Data/WCVI15LC_4000, 79-82 BP.CSV", "Data/wcvi_spfi.csv")
